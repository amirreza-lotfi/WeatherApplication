...
public class MainActivityViewModel extends ViewModel {
        ...
        cityRepository.getCityDataFromServer(lat,lon)
                ...
                .subscribe(new SingleObserver<String>() {
                    ...
                    public void onSuccess(@NonNull String s) {
                        CityWeatherAllData cityWeatherAllData = new CityWeatherAllData(s);
                        cityWeatherDataInOneCallMutableLiveData.postValue(cityWeatherAllData);
    ...
    public MutableLiveData<CityWeatherAllData> getCityWeatherDataInOneCallMutableLiveData() {
